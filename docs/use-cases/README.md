...
|----|-------|------------|----------|--------|------------|
| UC-013 | Harden Dependency Hygiene | User Goal | P1 | Sprint 9 | UC-012 |

## Planned

| UC | Title | Goal Level | Priority | Sprint | Depends On |
|----|-------|------------|----------|--------|------------|
| UC-014 | Refactor ChatManager (TBD) | User Goal | P2 | Backlog | UC-013 |
...
| Phase 9: Hardening | In Progress | — | UC-013 (dependency hygiene) |
...
UC-005 (E2E) ── UC-003 (P2P) ✓ ── UC-004 (Relay) ✓              │
                                              ...
                                              UC-011 (Config) ✓ ──┤
                                                                   │
                                              UC-013 (Dep Hygiene) ← IN PROGRESS
                                                                   │
                                              UC-014 (ChatManager Refactor) ← BACKLOG
```
